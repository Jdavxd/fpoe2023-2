...
public class VentanaDeJuego extends JFrame implements ActionListener {
    ...
    public VentanaDeJuego(Jugador jugadorActual){
        ventanaDeJuego = new JFrame("Juego");
        ventanaDeJuego.setSize(800, 500);
    ...
    public void iniciarComponentes(){
        ...
        //label de el nombre
        lblTextoNombre = new JLabel("Nombre del jugador: " + jugador.getNombre());
        Font comicSansFont = new Font("Comic Sans MS", Font.PLAIN, 16);
        lblTextoNombre.setFont(comicSansFont);
        lblTextoNombre.setBounds(400, 10, 230, 22);
        panel.add(lblTextoNombre);
